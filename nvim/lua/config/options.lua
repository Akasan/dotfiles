...
vim.g.loaded_python3_provider = 0 -- enable Python3 support
vim.g.loaded_ruby_provider = 0 -- enable ruby support
vim.g.loaded_node_provider = 0 -- enable node support
vim.g.loaded_perl_provider = 0 -- enable perl support
...
-- arabic settings
vim.o.arabic = false -- change current directory bases on the latest opened file
vim.o.arabicshape = true
vim.o.autochdir = false -- change current directory based on the latest opened file
vim.o.autoindent = true -- set indent based on the line above
vim.o.autoread = true -- read file automatically when file is changed editted by not vim
vim.o.autowrite = true --
vim.o.autowriteall = false -- autowrite + save contents when file closed
vim.o.background = "dark" -- background color is automatically adjusted
vim.o.backspace = "indent,eol,start" -- indent: apply backspace over auto indent, eol: apply backspace over multiline, start: refer document
vim.o.backup = false -- generate bacvkup file when overwrite file
vim.o.backupcopy = "auto" -- how to generate backup file (automatically selected)
vim.o.backupext = "~" -- extension of backup file
vim.o.backupskip = "/tmp/*" -- backup files are not created if this pattern matches
vim.o.belloff = "all" -- event list to call bell
vim.o.binary = false -- option for when editing binary files
vim.o.bomb = false -- whether BOM is set to top of file
vim.o.breakat = " \t!@*-+;:,./?" -- set new line automatically when any keyword entered if linebreak is true
vim.o.breakindent = false -- show breaked line in same indent
vim.o.breakindentopt = "" -- breakindent option
-- vim.o.browsedir = ""
vim.o.bufhidden = "" -- behaviour when buffer is no longer showing
vim.o.buflisted = true -- show buffers on buffer list
vim.o.buftype = ""
vim.o.casemap = "internal,keepascii" -- detail configuration for upper and lower case
vim.o.cdhome = false -- set home directory
vim.o.cdpath = ",,"
vim.o.cedit = "\6"
-- vim.o.channel = 0
vim.o.charconvert = ""
